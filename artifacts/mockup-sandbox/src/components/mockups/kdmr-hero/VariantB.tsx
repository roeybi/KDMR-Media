    ...
    <div className="kdmr-root">
      <section className="cur-hero">
        <div className="vb-portrait">
          ...
          <div className="vb-tag">2026 Season</div>
          <div className="vb-badge">
            <span>Juara KDCA Klang Valley 2026</span>
          </div>
        </div>

        <div style={{ padding: "26px 20px 44px", background: "#0a0a0a" }}>
          ...
          <h1 style={{ fontSize: "2.2rem", fontWeight: 900, letterSpacing: "-0.035em", lineHeight: 1.02, color: "#f0f0f0", margin: "0 0 8px" }}>
          ...
          <p style={{ fontSize: "0.88rem", color: "#6a6a6a", lineHeight: 1.85, margin: "0 0 26px" }}>
