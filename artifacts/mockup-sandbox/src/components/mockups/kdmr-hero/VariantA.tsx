  ...
  return (
    <div className="kdmr-root">
      <section className="cur-hero">
        <div className="va-portrait">
          <div className="cur-deco" aria-hidden="true" />
          <div style={{ position: "absolute", top: 18, left: 18, zIndex: 3, fontSize: "0.54rem", fontWeight: 800, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(240,168,32,0.55)", border: "1px solid rgba(240,168,32,0.14)", padding: "4px 11px", borderRadius: 2 }}>
            2026 Season
          </div>
          ...
          <div style={{ position: "absolute", bottom: 18, left: "50%", transform: "translateX(-50%)", zIndex: 3 }}>
            <span style={{ display: "inline-block", background: "rgba(240,168,32,0.1)", border: "1px solid rgba(240,168,32,0.3)", color: "#f0a820", fontSize: "0.52rem", fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase", padding: "5px 13px", borderRadius: 2, whiteSpace: "nowrap" }}>
