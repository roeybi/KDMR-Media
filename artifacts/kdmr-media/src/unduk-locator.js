      ...
      <div class="ul-map-col">
        ...
        <div id="mapPanel-peninsula" class="map-panel active">
          ...
          <svg id="peninsulaSvg" class="map-svg" viewBox="0 38 130 158" style="display:block;overflow:visible;max-width:380px;margin:0 auto;" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Pulau Pinang -->
            <g class="un-node" data-tab="Pulau Pinang" data-name="Pulau Pinang" data-sub="KDCA Pulau Pinang · 2026" data-winner="Jeraahfinah Jonis (Nanu)" data-img="jeraahfinah-jonis.png">
              ...
              <g class="un-node-body">
                ...
                <image href="/images/jeraahfinah-jonis.png" x="12" y="50" width="16" height="16" clip-path="url(#cpPP)" preserveAspectRatio="xMidYMid slice" style="pointer-events:none;"/>
            ...
            <g class="un-node" data-tab="Melaka" data-name="Melaka" data-sub="KDCA Melaka · 2026" data-winner="Clarissa Jane Ahap Fred Michael" data-img="placeholder-winner_nobg.png">
              ...
              <g class="un-node-body">
                ...
                <image href="/images/placeholder-winner_nobg.png" x="101" y="135" width="14" height="14" clip-path="url(#cpM)" preserveAspectRatio="xMidYMid slice" style="pointer-events:none;"/>
        ...
        <div id="mapPanel-sarawak" class="map-panel">
          ...
          <svg id="sarawakSvg" class="map-svg" viewBox="114 72 152 128" style="display:block;overflow:visible;max-width:440px;margin:0 auto;" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Sarawak pin -->
            <g class="un-node" data-tab="Sarawak" data-name="Sarawak" data-sub="KDCA Sarawak · 2026" data-winner="Deanera Clarissa Jamdin" data-img="placeholder-winner_nobg.png">
              ...
              <g class="un-node-body">
                ...
                <image href="/images/placeholder-winner_nobg.png" x="147" y="85" width="22" height="22" clip-path="url(#cpSWK)" preserveAspectRatio="xMidYMid slice" style="pointer-events:none;"/>
