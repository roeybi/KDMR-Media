...
const i18n = {
  en: {
    ...
    button_download_png:   "Download",
    button_facebook:       "Facebook",
    button_ig_story:       "IG Story",
    share_to_label:        "Share to:",
    share_preparing:       "Loading images…",
    share_ready_fallback:  "Ready — tap to share",
  ...
  ms: {
    ...
    button_download_png: "Muat Turun",
    button_facebook:     "Facebook",
    button_ig_story:     "IG Story",
    share_to_label:      "Kongsi ke:",
    share_preparing:     "Memuatkan gambar…",
    share_ready_fallback:"Sedia — ketik untuk kongsi",
